...
_import_structure = {
    ...
    "distillation_trainer": ["DistillationTrainer", "DistillationTrainerWithImageLoss"],
...
if TYPE_CHECKING:
    ...
    from .distillation_trainer import DistillationTrainer, DistillationTrainerWithImageLoss
